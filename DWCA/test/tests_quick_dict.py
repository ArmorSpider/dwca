...
class Test(TestCase):
    ...
    def test_empty_string_should_return_empty_dict(self):
        input_string = ''
        expected = {}
        actual = quick_dict(input_string)
    ...
    def test_match_map_should_adjust_to_close_matches(self):
        ...
        expected = {'fruits': 'banana',
                    'people': 'the_emperor',
                    'food': 'bacon'}
        actual = quick_dict(input_string, match_map=self.match_map)
        self.assertEqual(expected, actual)

    def test_pair_with_no_match_should_be_allowed(self):
    ...
    def test_pair_with_half_match_should_be_allowed(self):
        input_string = 'frts: ccc'
        expected = {'fruits': 'ccc'}
        actual = quick_dict(input_string, match_map=self.match_map)
        self.assertEqual(expected, actual)
